...
const services = [
  {
    ...
    image: "/images/displayadvertisment.jpeg",
  },
  {
  ...
  },
  {
    ...
    image: "/images/b2bcontentsyndication.png",
  },
  {
    ...
    image: "/images/account-based-marketing-stats_3.webp",
  },
  {
  ...
  },
  {
    ...
    image: "/images/sales-qualified-lead.jpg",
  },
  {
    title: "Intent Leads",
  ...
  },
  {
    ...
    image: "/images/datasolutions.jpg",
  },
  {
    ...
    <section className="bg-[#f5f5f5] py-20 text-black">
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-start justify-between">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          <h3 className="text-xl font-semibold text-gray-800">How We Drive Results</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold">Data-Driven Optimization</p>
                <p className="text-gray-600 text-sm">
