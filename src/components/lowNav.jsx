...
const services = [
  { name: "Display Advertisement", image: "/images/service1.jpg", link: "/Displayads" },
  { name: "Account Based Marketing", image: "/images/service2.png", link: "#" },
  { name: "Lead Generation", image: "/images/service3.jpeg", link: "#" },
...
const solutions = [
  ...
  { name: "Sales-Qualified Leads", image: "/images/solution2.jpg", link: "/Salesqualified" },
...
<div className="relative group">
  <div className="flex items-center text-gray-700 hover:text-[#00d9a6] font-bold text-sm tracking-wide transition-all duration-300 cursor-pointer">
    B2B KNOWLEDGE BASE
    <ChevronDownIcon className="w-4 h-4 ml-1 group-hover:rotate-180 transition-transform duration-300" />
  </div>

  {/* Dropdown Menu */}
  <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
    <div className="flex flex-col lg:flex-row gap-4 bg-white lg:bg-transparent rounded-2xl p-4 lg:p-0 shadow-2xl border border-gray-100 lg:border-none">
      
      {/* Whitepaper Card */}
      <Link href="/whitepaper">
        <div className="w-60 lg:w-62 h-20 lg:h-30 bg-white lg:bg-[url('/images/whitepaper.webp')] bg-cover bg-center rounded-2xl p-4 flex flex-col justify-end transition-all hover:scale-105 hover:shadow-lg">
          <span className="text-sm font-semibold  text-gray-700 lg:text-white">Whitepaper</span>
        </div>
      </Link>

      {/* Blogs Card */}
      <Link href="/blogs">
        <div className="w-60 lg:w-62 h-20 lg:h-30 bg-white lg:bg-[url('/images/blog.webp')] bg-cover bg-center rounded-2xl p-4 flex flex-col justify-end transition-all hover:scale-105 hover:shadow-lg">
          <span className="text-sm font-semibold text-gray-700 lg:text-white">Blogs</span>
        </div>
      </Link>
...
<div className="space-y-2">
  ...
  >
    ...
    <ChevronDownIcon className={`w-4 h-4 transition-transform duration-200 ${mobileB2BOpen ? 'rotate-180' : ''}`} />
  </div>
